...
public:
  ...
  QString DataDownloadFormat{
      QStringLiteral("NETCDF4")}; ///< Format to download netCDF files: same
                                  ///< values as on Ocean Navigator web gui.
  bool UpdateRemoteListOnStart{
      true}; ///< Should we update dataset list from dory when starting
