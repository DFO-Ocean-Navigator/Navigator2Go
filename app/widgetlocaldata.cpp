...
/***********************************************************************************/
WidgetLocalData::WidgetLocalData(const QString *installDir, QWidget *parent)
    : QWidget{parent}, m_ui{new Ui::WidgetLocalData}, m_ONInstallDir{
                                                          installDir} {
  m_ui->setupUi(this);
...
/***********************************************************************************/
WidgetLocalData::~WidgetLocalData() { delete m_ui; }
...
void WidgetLocalData::updateTreeWidget() {
  ...
  for (const auto &datasetName : keys) {
    ...
    QObject::connect(delButton, &QPushButton::clicked, this,
                     &WidgetLocalData::buttonHandler);
...
void WidgetLocalData::buttonHandler() {
  ...
  box.setText(tr("Are your sure you wish to delete ") + dsName +
              QStringLiteral("?"));
