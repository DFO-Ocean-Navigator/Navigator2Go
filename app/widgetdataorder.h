...
private:
	...
	QHash<QString, QJsonObject> m_datasetsAPIResultCache;	///< Cache API results by dataset ID
	QHash<QString, DataDownloadDesc> m_downloadQueue;		///< Download queue maps dataset ID to download description
